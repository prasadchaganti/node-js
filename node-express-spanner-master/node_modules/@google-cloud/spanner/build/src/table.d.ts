...
declare type Schema = string | string[] | {
    statements: string[];
    operationId?: string;
};
declare type CommitPromise = Promise<[s.CommitResponse]>;
declare type CreateTablePromise = Promise<[Table, d.Operation, d.GrpcOperation]>;
declare type DropTablePromise = Promise<[d.Operation, d.GrpcOperation]>;
