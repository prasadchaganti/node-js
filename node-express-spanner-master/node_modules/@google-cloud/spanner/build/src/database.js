 ...
 */
class Database extends common_grpc_1.ServiceObject {
    constructor(instance, name, poolOptions) {
        ...
        let PoolCtor = session_pool_1.SessionPool;
     ...
     * });
     */
    runTransactionAsync(optionsOrRunFn, fn) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [session, transaction] = yield promisify_1.promisify(getWriteSession)();
